...
export function ClientList() {
  ...
  return (
    <div className="space-y-6">
      {/* Upload Section */}
      <div className="p-8 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg border-2 border-dashed border-blue-200">
      ...
      {/* Filters & Search */}
      <div className="p-4 bg-white rounded-lg border border-slate-200 flex flex-col sm:flex-row gap-4">
